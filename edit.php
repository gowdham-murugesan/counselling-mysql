<?php
		...
		$edit = mysqli_query($conn,"UPDATE counselling SET College_Code='$College_Code', College_Name='$College_Name', Branch_Name='$Branch_Name', Closing_Cutoff='$Closing_Cutoff' WHERE Choice_Order='$id'");
