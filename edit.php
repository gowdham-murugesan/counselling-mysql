<?php
		...
		$qry = mysqli_query($conn,"SELECT * FROM sql6434984.counselling where Choice_Order='$id';");
		...
		$edit = mysqli_query($conn,"UPDATE sql6434984.counselling SET College_Code='$College_Code', College_Name='$College_Name', Branch_Name='$Branch_Name', Closing_Cutoff='$Closing_Cutoff' WHERE Choice_Order='$id'");
...
<p>
				...
				<select name="College_Name" id="College_Name" autocomplete="off" onchange="College(); Cutoff(); return false;">
					...
					<option value="" id="testoption416"></option>
...
<p>
				...
				<select name="Branch_Name" id="Branch_Name" onchange="Cutoff(); return false;">
					...
					<option value="" id="branchoption25"></option>
